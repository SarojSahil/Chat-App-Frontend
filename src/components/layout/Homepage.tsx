...
export const Homepage = () => {
  ...
  return (
    <div ref={containerRef} className="bg-zinc-50 text-zinc-900 overflow-x-hidden">
      ...
      {/* Progress Bar */}
      <div className="progress-bar fixed top-0 left-0 w-full h-1 bg-emerald-500 origin-left scale-x-0 z-[100]" />
      ...
      <nav className="fixed top-0 w-full z-90 flex justify-between items-center px-10 py-6 mix-blend-difference text-white">
        ...
        <Link to="/login" className="text-sm font-bold border-b-2 border-emerald-500 pb-1">Enter App</Link>
      </nav>
      ...
      <section className="h-screen flex items-center justify-center relative bg-white">
        <div className="text-center z-10">
          <h1 className="text-[12vw] font-black leading-none tracking-tighter uppercase italic">
            Sanvaad <br /> <span className="text-emerald-500 not-italic">01</span>
          </h1>
          <p className="mt-4 font-mono text-zinc-400">SCROLL TO EXPLORE THE FUTURE OF CHAT</p>
        </div>
        <div className="absolute bottom-10 animate-bounce text-emerald-500">
      ...
      <section className="horizontal-section h-screen bg-zinc-900 flex items-center overflow-hidden">
        <div className="horizontal-scroll-wrapper flex gap-20 px-20">
          <div className="w-[400px] h-[500px] flex-shrink-0 bg-emerald-500 rounded-3xl p-10 flex flex-col justify-end">
          ...
          <div className="w-[400px] h-[500px] flex-shrink-0 bg-emerald-100 rounded-3xl p-10 flex flex-col justify-end">
            <h3 className="text-4xl font-black text-emerald-900">Custom <br /> Hooks</h3>
          </div>
          <div className="w-[700px] h-[500px] flex-shrink-0 bg-zinc-950 rounded-3xl p-10 flex flex-col justify-end border-l-4 border-emerald-500">
            <h3 className="text-4xl font-black text-white">End-to-End <br /> Visibility</h3>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="list-container space-y-12">
            ...
            {[
              ...
              { title: "Redux / Zustand", desc: "State management done right." },
              { title: "MySQL", desc: "Reliable persistent storage." }
            ].map((item, i) => (
              <div key={i} className="list-item border-l-2 border-zinc-200 pl-6 py-2 group hover:border-emerald-500 transition-colors">
                <h4 className="text-xl font-bold group-hover:text-emerald-500">{item.title}</h4>
          ...
          <div className="perspective-1000 relative h-[600px]">
            <div className="floating-card absolute top-0 left-0 w-64 h-80 bg-white shadow-2xl rounded-2xl border border-zinc-100 z-30 p-6">
              <div className="w-10 h-10 rounded-full bg-emerald-500 mb-4" />
      ...
      <section className="py-60 bg-white border-y border-zinc-100 text-center px-4">
        <blockquote className="text-4xl md:text-7xl font-black max-w-6xl mx-auto leading-[1.1] tracking-tighter">
          "The best way to <span className="text-zinc-300">predict</span> the future is to <span className="text-emerald-500 italic">build</span> it."
        </blockquote>
      </section>
      ...
      <section className="h-[200vh] relative bg-zinc-900 flex flex-col items-center pt-40">
        <div className="sticky top-40 text-center w-full px-4">
          <h2 className="text-emerald-400 font-mono text-sm tracking-[0.3em] uppercase mb-6">Experience SANVAAD</h2>
      ...
      <section className="py-40 bg-white flex flex-col items-center">
        <div className="w-32 h-32 bg-emerald-500 rounded-[2rem] flex items-center justify-center rotate-12 hover:rotate-0 transition-transform duration-500 shadow-2xl shadow-emerald-200 mb-12">
        ...
        <p className="text-zinc-400 mb-10 text-xl font-medium">Your graduation project, perfected.</p>
        <div className="flex gap-4">
          ...
          <button className="px-12 py-6 border-2 border-zinc-900 text-zinc-900 font-bold rounded-2xl hover:bg-zinc-900 hover:text-white transition-all">Documentation</button>
        </div>
      </section>

      <footer className="p-10 border-t border-zinc-100 flex flex-col md:flex-row justify-between items-center text-zinc-400 text-xs font-bold tracking-widest uppercase">
        <div>Mumbai — Uttar Pradesh</div>
        <div className="mt-4 md:mt-0 italic">Designed with GSAP Power</div>
        <div className="mt-4 md:mt-0">© 2026 SANVAAD PROJECT</div>
      </footer>
    </div>
  );
};